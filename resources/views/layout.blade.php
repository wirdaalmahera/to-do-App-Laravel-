...
<body>
    @if (Auth::check())
    <nav class="navbar navbar-expand-lg" style="background: #D2D79F;">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto navbar-right-top">
                <li class="nav-item dropdown nav-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right nav-user-dropdown mx-5" aria-labelledby="navbarDropdownMenuLink2">
